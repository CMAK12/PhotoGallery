        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumIds = table.Column<string[]>(type: "text[]", nullable: false),
                    LikedImagesIds = table.Column<string[]>(type: "text[]", nullable: false),
                    DislikedImagesIds = table.Column<string[]>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
